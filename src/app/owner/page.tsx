      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 pt-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          ...
          <Link href="/owner/staff">
            <button className="bg-white text-green-600 border-2 border-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition">
              직원 관리
            </button>
          </Link>
